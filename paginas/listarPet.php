...
<html lang="pt-br">  
    ...
    ?>
		...
		<tbody>
            ...
            $query = "SELECT pet.idPet, pet.nomePet,cliente.nomeCliente,pet.raca, pet.idadePet, pet.especie FROM pet INNER JOIN cliente ON pet.proprietario = cliente.idCliente";
